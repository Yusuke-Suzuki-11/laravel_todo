        ...
        <div class="col"  style="margin-bottom: 30px;">
            <nav class="panel panel-default">
                ...
                <div class="card-body list-group-item text-center" style="width: 65%; margin:0 auto; padding: 30px 0">
                    ...
                    @if ($user->gym_name == null)
                    <span style="font-size: 25px; font-weight: bold">未設定です</span>
                    @endif
                ...
                <div class="card-body list-group-item text-center" style="width: 65%; margin:0 auto; padding: 30px 0">
                    ...
                    @if ($user->gym_name == null)
                    <span style="font-size: 25px; font-weight: bold">未設定です</span><br>
                    @endif
                    <span style="font-size: 25px; font-weight: bold">{{ $user->gym_address }}</span><br>
                    <div id="map" class="center-block" style="width: 100%; height: 500px; border-radius: 10px; box-shadow: 1px 1px 3px 1px slategray; margin-bottom: 50px;" ></div>
